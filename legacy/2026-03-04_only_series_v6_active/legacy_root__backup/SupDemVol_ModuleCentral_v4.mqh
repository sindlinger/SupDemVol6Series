...
#include "SupDemVol_ModuleOrganizacao_v4.mqh"
#include "SupDemVol_ModuleCriacao_v4.mqh"
#include "SupDemVol_ModuleMerge_v4.mqh"
...
void SDV4_ModuloCentralProcessar(const int rates_total,
   ...
   SDV4_ModuloOrganizacaoProcessar(rates_total, barraNova, time, close, deveRecalcular);
   SDV4_ModuloCriacaoProcessar(rates_total, time, open, high, low, close, tick_volume, deveRecalcular, houveCriacaoNova);
   SDV4_ModuloMergeProcessar(rates_total, barraNova, time, high, low, close, tick_volume, deveRecalcular, houveIncrementoVolumeToque);
