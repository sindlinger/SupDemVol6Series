...
// Variáveis globais
string g_prefixo = "VProfile7_v3_";
long g_chartID;
...
int OnCalculate(const int rates_total,
   ...
   if(InpMostrarProfile) {
      SDV3_ModuloCentralProcessar(rates_total, prev_calculated, time, high, low, close, tick_volume);
   }
...
#include "SupDemVol_ModuleCentral_v3.mqh"
